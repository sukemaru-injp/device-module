...
function isMobileOrTablet (a) {
  if (window) {
    return  REGEX_MOBILE_OR_TABLET1.test(a) || REGEX_MOBILE_OR_TABLET2.test(a.substr(0, 4)) || (a.match(/Mac/) && window?.navigator?.maxTouchPoints && window?.navigator?.maxTouchPoints > 2)
  }
